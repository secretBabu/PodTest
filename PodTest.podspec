...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/secretBabu/PodTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'secretBabu' => '383190947@qq.com' }
  s.source           = { :git => 'https://github.com/secretBabu/PodTest.git', :tag => s.version.to_s }
